# -*- coding: utf-8 -*-
"""
Created on Sun Jun  9 20:11:30 2024
    ...
    def train(self, terminal_state):
        ...
        for index, (current_state, action, reward, new_current_state, done) in enumerate(minibatch):
            if not done:
                ...
                #DDQN
                max_future_q_action = np.argmax(future_qs_list[index])
                max_future_q = target_future_qs_list[index][max_future_q_action]
...
ep_mode = {"directed": 1, "random": 5, "possible":200}
        ...
        if mode == "directed":
            ...
            if np.random.random() > epsilon:
                ...
                if mode == "possible":
                    ...
                    filtered_actions = [a for a in agent.state_possible_actions[hash_key ]if env.action_dict[a]["action_grounded"].split("-")[1]
                                        not in ["CHANGE","UNSELECT"]]
